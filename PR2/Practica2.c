...
static double medir_tiempo_shell(const int origen[], int n, const int inc[], int m);
...
void test_ins2(){
    encabezado("ORDENACION POR INSERCION (vector desordenado)", 1.8, 2, 2.2);
    ...
    encabezado("ORDENACION POR INSERCION (vector ordenado)", 1.8, 2, 2.2);
     for (int k=0;k<NUM_N;k++){
        int n = Ns[k];
        int *v = (int*)malloc(n*sizeof(int));
        ArrAsc(v, n);
    ...
    encabezado("ORDENACION POR INSERCION (vector ordenado descendiente)", 1.8, 2, 2.2);
     for (int k=0;k<NUM_N;k++){
        int n = Ns[k];
        int *v = (int*)malloc(n*sizeof(int));
        ArrayDesc(v, n);
...
void test_shell2() {
    ...
    encabezado("ORDENACION POR SHELL (Hibbard))", 1.8, 2, 2.2);
     for (int k=0;k<NUM_N;k++){
        int n = Ns[k];
        int *v = (int*)malloc(n*sizeof(int));
        aleatorio(v, n);
        double t = medir_tiempo_shell(v, n, hibbard, 3);
        fila(n, t, 1.8, 2.0, 2.2);
        free(v);
    }

    encabezado("ORDENACION POR SHELL (Knuth))", 1.8, 2, 2.2);
     for (int k=0;k<NUM_N;k++){
        int n = Ns[k];
        int *v = (int*)malloc(n*sizeof(int));
        aleatorio(v, n);
        double t = medir_tiempo_shell(v, n, knuth, 3);
        fila(n, t, 1.8, 2.0, 2.2);
        free(v);
    }

    encabezado("ORDENACION POR SHELL (Sedgewick))", 1.8, 2, 2.2);
     for (int k=0;k<NUM_N;k++){
        int n = Ns[k];
        int *v = (int*)malloc(n*sizeof(int));
        aleatorio(v, n);
        double t = medir_tiempo_shell(v, n, sedgewick, 5);
        fila(n, t, 1.8, 2.0, 2.2);
        free(v);
    }

    encabezado("ORDENACION POR SHELL (Ciura))", 1.8, 2, 2.2);
     for (int k=0;k<NUM_N;k++){
        int n = Ns[k];
        int *v = (int*)malloc(n*sizeof(int));
        aleatorio(v, n);
        double t = medir_tiempo_shell(v, n, ciura, 8);
        fila(n, t, 1.8, 2.0, 2.2);
        free(v);
    }
}
